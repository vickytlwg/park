...
@RequestMapping(value="getReceiveData",method=RequestMethod.GET,produces={"application/json;charset=UTF-8"})
@ResponseBody
...
@RequestMapping(value="testForSingnalParkInfo",method=RequestMethod.GET,produces={"application/json;charset=UTF-8"})
@ResponseBody
...
//	javaBeanXml.updateParkFromXml();
	//String xml=ParkDelegate.singleParkInfo("admin_pt", "cadre_pt", "pt31010700079");
	return Utility.createJsonMsg(1001, "ok", singleParkInfos);
}
@RequestMapping(value="getForSingnalParkInfo",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
@ResponseBody
...
@RequestMapping(value="getForSingnalIOInfo",method=RequestMethod.POST,produces={"application/json;charset=UTF-8"})
@ResponseBody
