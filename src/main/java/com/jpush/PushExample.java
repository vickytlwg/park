...
public class PushExample {
	...
	public static final String TITLE = "测试消息 title";
    public static final String ALERT = "测试消息 alert-for_tag";
...
//        testSendIosAlert();
	...
	public static void testSendPush() {
      ...
      //  PushPayload payload = buildPushObject_android_tag_alertWithTitle();
        PushPayload payload = buildPushObject_android();
   //     PushPayload pushPayload=buil
    ...
    public static PushPayload buildPushObject_android_tag_alertWithTitle() {
        return PushPayload.newBuilder()
                ...
                .setAudience(Audience.tag("2017003"))
