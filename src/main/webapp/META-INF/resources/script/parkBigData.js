(function($) {
 ...
 //       chart2Init();
    ...
    var mapClusterer;
    var myIconred = new BMap.Icon("/park/image/red.png", new BMap.Size(23, 25), {
    });
    var myIcongreen = new BMap.Icon("/park/image/green.png", new BMap.Size(23, 25), {
    });
    var myIconyellow = new BMap.Icon("/park/image/yellow.png", new BMap.Size(23, 25), {
    });
